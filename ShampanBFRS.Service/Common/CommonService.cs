...
namespace ShampanBFRS.Service.Common
{
    public class CommonService
    {
        ...
        public async Task<ResultVM> PersonnelCategoriesList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.PersonnelCategoriesList(conditionalFields, conditionalValues, vm, conn, transaction);
        ...
        public async Task<ResultVM> GetChargeGroupList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.GetChargeGroupList(conditionalFields, conditionalValues, vm, conn, transaction);
        ...
        public async Task<ResultVM> SegmentList(string[] conditionalFields, string[] conditionalValues, PeramModel vm = null)
        {
            CommonRepository _repo = new CommonRepository();
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            ...
            try
            {
                ...
                result = await _repo.SegmentList(conditionalFields, conditionalValues, vm, conn, transaction);
