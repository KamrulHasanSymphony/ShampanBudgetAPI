...
{
    public class BudgetOtherDepartmentRepository : CommonRepository
    {

        public async Task<ResultVM> Insert(BudgetOtherDepartmentHeaderVM vm, SqlConnection conn, SqlTransaction transaction)
        {
            ...
            {
                string query = @"
        INSERT INTO BudgetOtherDepartmentHeaders
        (
            CompanyId,
            BranchId,
            FiscalYearId,
        ...
        public async Task<ResultVM> Update(BudgetOtherDepartmentHeaderVM vm, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
                ...
                string query = @"
                    UPDATE BudgetOtherDepartmentHeaders
                    SET
...
FROM BudgetOtherDepartmentHeaders M
...
WHERE 1 = 1
                ...
                var modelList = dataTable.AsEnumerable().Select(row => new BudgetOtherDepartmentHeaderVM
                {
                    Id = row.Field<int>("Id"),
        ...
        WHERE 1 = 1
          ...
          {(options.filter.Filters.Count > 0
                      ? " AND (" + GridQueryBuilder<BudgetOtherDepartmentDetailVM>.FilterCondition(options.filter) + ")"
                      : "")}
        ...
        ";
                ...
                var data = KendoGrid<BudgetOtherDepartmentDetailVM>
        ...
        public async Task<ResultVM> InsertDetails(BudgetOtherDepartmentDetailVM detail, SqlConnection conn, SqlTransaction transaction)
        {
            ResultVM result = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
            ...
            try
            {
                ...
                sqlText = @" INSERT INTO BudgetOtherDepartmentDetails (

 
                 BudgetOtherDepartmentHeaderId
                ,SabreId
                ,InputTotal
                ,M1
                ,M2
                ...
                commands.Parameters.Add("@BudgetOtherDepartmentHeaderId", SqlDbType.Int).Value = detail.BudgetOtherDepartmentHeaderId;
        ...
        public async Task<ResultVM> DetailsList(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ...
            try
            {
              ...
              SELECT 
                 ISNULL(D.Id, 0) AS Id
                 ,D.BudgetOtherDepartmentHeaderId
                 ,D.SabreId
                 ,D.InputTotal
                 ,D.M1
                 ,D.M2
                 ...
                 ,S.Code        AS SabreCode
                 ,S.Name      AS SabreName
                  FROM BudgetOtherDepartmentDetails D 
                ...
                if (vm != null && !string.IsNullOrEmpty(vm.Id))
                {
                    query += " AND D.BudgetOtherDepartmentHeaderId = @Id ";
                }
        ...
        public async Task<ResultVM> GetGridData(GridOptions options, string[] conditionalFields, string[] conditionalValues, SqlConnection conn, SqlTransaction transaction)
        {
            ...
            try
            {
                ...
                var data = new GridEntity<BudgetOtherDepartmentHeaderVM>();
...
WHERE 1 = 1
                ...
                " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<BudgetOtherDepartmentHeaderVM>.FilterCondition(options.filter) + ")" : "");
            ...
            ";
                ...
                data = KendoGrid<BudgetOtherDepartmentHeaderVM>.GetTransactionalGridData_CMD(options, sqlQuery, "M.Id", conditionalFields, conditionalValues);
        ...
        public async Task<ResultVM> GetDetailDataById(GridOptions options, int masterId, SqlConnection conn, SqlTransaction transaction)
        {
            ...
            try
            {
                var data = new GridEntity<BudgetOtherDepartmentDetailVM>();
                ...
                WHERE D.BudgetOtherDepartmentHeaderId = @masterId
                -- Add the filter condition
                " + (options.filter.Filters.Count > 0 ? " AND (" + GridQueryBuilder<BudgetOtherDepartmentDetailVM>.FilterCondition(options.filter) + ")" : "") + @"
                ...
                data = KendoGrid<BudgetOtherDepartmentDetailVM>.GetGridData_CMD(options, sqlQuery, "H.Id");
...
SET @SQL += '
FROM BudgetOtherDepartmentHeaders c
INNER JOIN BudgetOtherDepartmentDetails cd ON c.Id = cd.BudgetOtherDepartmentHeaderId
...
";
        ...
        public async Task<ResultVM> BudgetTransferHeader(BudgetOtherDepartmentHeaderVM objMaster, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ResultVM result = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
            ...
            try
            {
                ...
                string checkQuery = @"
SELECT COUNT(Id) FROM BudgetOtherDepartmentHeaders WHERE BranchId = @BranchId 
...
,@TransactionType
        ...
        public async Task<ResultVM> BudgetTransferDetails(BudgetOtherDepartmentHeaderVM objMaster, SqlConnection conn = null, SqlTransaction transaction = null)
        {
            ResultVM result = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
...
INSERT INTO BudgetOtherDepartmentDetails (
 BudgetOtherDepartmentHeaderId
,SabreId
,InputTotal
,M1
...
,sum(cd.Yearly)
,'N'
from BudgetOtherDepartmentDetails cd
left outer join BudgetOtherDepartmentHeaders s on s.Id =cd.BudgetOtherDepartmentHeaderId 
where 1=1
...
";
                ...
                commands.Parameters.Add("@BudgetOtherDepartmentHeaderId", SqlDbType.Int).Value = objMaster.Id;
...
//FROM BudgetDetails D
//LEFT JOIN BudgetHeaders bh ON bh.Id = D.BudgetOtherDepartmentHeaderId
