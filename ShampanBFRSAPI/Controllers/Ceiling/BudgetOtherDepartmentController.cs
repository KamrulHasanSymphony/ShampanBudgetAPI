...
namespace ShampanBFRSAPI.Controllers.Ceiling
{
    ...
    [ApiController]
    public class BudgetOtherDepartmentController : ControllerBase
    {
        BudgetOtherDepartmentService _Service = new BudgetOtherDepartmentService();
        CommonService _common = new CommonService();

        [HttpPost("Insert")]
        public async Task<ResultVM> Insert(BudgetOtherDepartmentHeaderVM vm)
        {
            ResultVM resultVM = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
            try
            {
                _Service = new BudgetOtherDepartmentService();
        ...
        [HttpPost("Update")]
        public async Task<ResultVM> Update(BudgetOtherDepartmentHeaderVM VM)
        {
        ...
        public async Task<ResultVM> BudgetTransfer(BudgetOtherDepartmentHeaderVM vm)
        {
            ResultVM resultVM = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
            try
            {
