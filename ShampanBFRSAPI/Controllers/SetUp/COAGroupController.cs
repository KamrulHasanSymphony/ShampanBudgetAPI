...
namespace ShampanBFRSAPI.Controllers.SetUp
{
    ...
    [ApiController]
    public class COAGroupController : ControllerBase
    {
        COAGroupService _coagroupService = new COAGroupService();
        ...
        public async Task<ResultVM> Insert(COAGroupVM coagroup)
        {
            ...
            try
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.Insert(coagroup);
                return resultVM;
            }
            catch (Exception ex)
            {
                return new ResultVM { Status = MessageModel.Fail, Message = ex.Message, ExMessage = ex.Message, DataVM = coagroup };
            }
        }
        ...
        public async Task<ResultVM> Update(COAGroupVM coagroup)
        {
            ...
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.Update(coagroup);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> Delete(CommonVM vm)
        {
            ...
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.Delete(vm);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> List(CommonVM vm)
        {
            ...
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.List(new[] { "M.Id" }, new[] { vm.Id }, null);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> ListAsDataTable(COAGroupVM coagroup)
        {
            ResultVM resultVM = new ResultVM { Status = MessageModel.Fail, Message = "Error" };
            try
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.ListAsDataTable(new[] { "" }, new[] { "" });
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> Dropdown()
        {
            ...
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.Dropdown();
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultVM> GetGridData(GridOptions options)
        {
            ...
            {
                _coagroupService = new COAGroupService();
                resultVM = await _coagroupService.GetGridData(options);
                return resultVM;
            }
            catch (Exception ex)
            {
        ...
        public async Task<FileStreamResult> ReportPreview(CommonVM vm)
        {
            ...
            try
            {
                ...
                var resultVM = await _coagroupService.ReportPreview(
